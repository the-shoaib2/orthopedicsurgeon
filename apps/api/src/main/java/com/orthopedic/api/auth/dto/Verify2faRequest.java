...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request object for 2FA verification")
public class Verify2faRequest {
    ...
    @Schema(description = "6-digit TOTP code from user's app", example = "123456", requiredMode = Schema.RequiredMode.REQUIRED)
