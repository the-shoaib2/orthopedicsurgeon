...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ZrdStatComponent, ZrdCardComponent, ZrdTableComponent, ZrdBadgeComponent, ZrdAvatarComponent, ZrdButtonComponent, ZrdPageHeaderComponent],
  template: `
